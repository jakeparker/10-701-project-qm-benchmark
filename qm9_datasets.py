...
def load_qm9(featurizer='CoulombMatrix', split='random', frac_train=0.8, reload=True):
  """Load qm9 datasets."""
  ...
  if reload:
    deepchem.utils.save.save_dataset_to_disk(
        save_dir, train_dataset, test_dataset, transformers)
  return qm9_tasks, (train_dataset, test_dataset), transformers